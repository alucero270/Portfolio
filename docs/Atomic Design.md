...
12 ATOMIC DESIGN
process. The earliest cars and components were individually crafted,
...
14 ATOMIC DESIGN
Out with the old! In with the new! It’s certainly an attractive
...
- For A Future-Friendly Web
  ...
  16 ATOMIC DESIGN
  In the future, what I believe is that we are going to have better
...
- Stephen Hay
  ...
  Style tiles, a concept created by designer Samantha Warren, allow designers to explore
...
22 ATOMIC DESIGN
Just like the real world, the diverse needs, goals, and desires of web
...
40 ATOMIC DESIGN
Chemical reactions are represented by chemical equations, which
...
42 ATOMIC DESIGN
Because we’re starting with a similar finite set of building blocks,
...
44 ATOMIC DESIGN
manner, each interface atom has its own unique properties, such
...
CHAPTER 2 / ATOMIC DESIGN METHODOLOGY 4546 ATOMIC DESIGN
Organisms
...
48 ATOMIC DESIGN
Templates
A product grid organism on Gap’s e-commerce website consists of the same product item molecule
...
50 ATOMIC DESIGN
prove the parts add up to a well-functioning whole. We’ll discuss this
more in a bit.
...
system to life.
54 ATOMIC DESIGN
At the page stage, we’re able to see what Time Inc.’s homepage looks like with real representative
...
- Mark Boulton
  58 ATOMIC DESIGN
  A well-crafted design system caters to the content that lives inside
...
- Jeff Crossman, GE Design
  ...
  work together.
  60 ATOMIC DESIGN
  “Atomic design” as a buzzword encapsulates the concepts of
  ...
  66 ATOMIC DESIGN
  Brian Muenzenmeyer, and me to execute atomic design systems.
...
68 ATOMIC DESIGN
tool that fits with your organization’s infrastructure and jives with
...
70 ATOMIC DESIGN
Now that we know what an include looks like, let’s put it into
...
72 ATOMIC DESIGN
When we crack open the hood to look at the header’s markup in
...
```
74 ATOMIC DESIGN
Take a quick stroll through the homepage template and you’ll see
...
76 ATOMIC DESIGN
A side-by-side comparison of Time Inc.’s homepage template and page levels. The template
...
“/images/sample/fpo_hero.png”. We’re simply defining this
...
hero_beyonce.jpg”.
Inside the ‘pages’ directory we have the homepage pattern as well as a JSON file that
...
80 ATOMIC DESIGN
allows us to articulate sometimes wildly different scenarios with
...
"title": "President of the Longest CompanyName in the World Corporation, Global Division"
```
},
```
```
...
84 ATOMIC DESIGN
anywhere we need it. Sometimes we may need it to be a full-bleed
...
88 ATOMIC DESIGN
This setup allows the core development team to maintain a single
...
90 ATOMIC DESIGN
```
Pattern Lab also provides a (dare I say) cool feature that enables you
```
...
92 ATOMIC DESIGN
the changes. The lineage feature also helps point out redundant
...
It’s important for all participants to capture screenshots using the same software so they can be
...
104 ATOMIC DESIGN
This is difficult as organizations tend to favor certain parts of the
```
...
sound idea of establishing an interface design system and pattern
...
Wolfram Nagel.
108 ATOMIC DESIGN
This approach to a Lego project is certainly a viable strategy, even if
...
pile of bricks and burning time reinventing patterns, you can create
...
110 ATOMIC DESIGN
Of course, it’s preferable to get your clients, colleagues, and
...
screen size, environment, technological capabilities, form-factor,
...
old machine.
112 ATOMIC DESIGN
However, this didn’t come without consequences. This print-like
...
looking at a smartphone, tablet, and desktop machine next to one
...
114 ATOMIC DESIGN
browser features, input types, form factors, contexts, and
...
designer goes away, puts their head down, and eventually emerges
...
116 ATOMIC DESIGN
yell, “Can you get this done in three weeks? We’re already behind
...
The waterfall process, where disciplines pass off work to each other in sequential order, isn’t likely
to result in great digital work.
118 ATOMIC DESIGN
every discipline to continue to consult with the others to ensure
...
often put in the same bucket as Python, Java, PHP, Ruby, C++, and
...
An iterative digital process is similar to subtractive stone sculpture, where fidelity is built up over
many iterations. Image credit: Mike Beauregard on Flickr
122 ATOMIC DESIGN
the process together. Get your entire team to commit to honest
...
Rather than jumping straight into such high-fidelity documents,
...
124 ATOMIC DESIGN
These blocky grayscale wireframes help establish the necessary
...
A simple spreadsheet can articulate what content and display patterns go on a given page while
describing their order and purpose.
126 ATOMIC DESIGN
As it turns out, there’s a better path to take to arrive at aesthetic
...
When the exercise is complete, quickly tally up the scores and come
...
For the Entertainment Weekly website redesign project, visual designers used style tiles to explore
color, type, texture, and more.
CHAPTER 4 / THE ATOMIC WORKFLOW 129
Style tiles facilitate conversation to uncover what stakeholders
...
An element collage for the Entertainment Weekly redesign applied color, typography, and texture
...
132 ATOMIC DESIGN
Front-end developers need to be the prep chefs of the web design
...
ɕ Front-end developers can set up project dependencies, stub out
...
point in the book.
134 ATOMIC DESIGN
For the TechCrunch project, Dan Mall riffed on the team’s initial
...
This grayscale prototype allowed us to demonstrate interactivity
...
big reveals.
In a more iterative process, there will be instances where some patterns are further developed
...
138 ATOMIC DESIGN
Dan Mall created a full comp to demonstrate what a featured article template for TechCrunch might
...
For the TechCrunch project, we created a comp for the article
...
CHAPTER 5 / MAINTAINING DESIGN SYSTEMS 143144 ATOMIC DESIGN
guide can provide documentation and serve as a helpful resource,
...
it serves, it becomes obsolete. And when the pattern library
...
CHAPTER 5 / MAINTAINING DESIGN SYSTEMS 145146 ATOMIC DESIGN
modify the dropdown pattern in the design system to remove the
...
Focusing on style guide delivery as the climax is the wrong
...
Design system makers and users.
152 ATOMIC DESIGN
Both outlooks are critical to the success of the design system,
...
partners are at a bit of a disadvantage since they don’t actually work
...
There is a spectrum of potential relationships between design system users and makers, and the
size and makeup of your company will undoubtedly shape those relationships.
CHAPTER 5 / MAINTAINING DESIGN SYSTEMS 155
There will inevitably be disciplines that actively do the work, while
...
time to map out their strategy as they created the Vanilla front-end
framework.
...
158 ATOMIC DESIGN
The design system maintainers need to understand why and when
...
applications? To address this issue, Salesforce created a neat utility
...
The holy grail of design systems is an environment where making changes to a UI pattern updates
...
Lonely Planet created an API for its UI patterns that is consumed by both their pattern library and
...
162 ATOMIC DESIGN
design system into applications to keep both codebases in lockstep.
...
The templating language can serve as the bridge between your
...
means that a synchronized pattern library isn’t really achievable
...
A homepage carousel on a site like Walmart requires input from many different disciplines and
...
Yelp’s style guide has an attractive, friendly front page that explains what the resource is, who it’s
for, and how to use it.
168 ATOMIC DESIGN
away in a dark corner of your intranet. What steps can you take to
...
Having a base for all these materials is a great idea, and keeping
```
...
170 ATOMIC DESIGN
Baking this communication into the team’s everyday workflow keeps
...
ɕ Onboarding: A great way of injecting your design system into
...
suggestions.
The Draft U.S. Web Digital Standards system tracks issues using GitHub, providing a place for users
and makers to file bugs and have conversations about the nitty-gritty.
CHAPTER 5 / MAINTAINING DESIGN SYSTEMS 173
ɕ Requests for feedback: Managing a system that can potentially
...
Since joining Salesforce, she’s helped create the ultra-successful
...
176 ATOMIC DESIGN
Another way to extend the functionality of the pattern library is to
...
But naming things in this manner immediately limits what type of
...
178 ATOMIC DESIGN
libraries show a demo of each UI pattern, but as we’ve discussed,
...
Tools like Pattern Lab provide lineage information, allowing teams to see which smaller components
...
With proper maintenance, your design system should increase in value over time like a bottle of fine
...
So there you have it. To make a maintainable design system, you
```
should:
```
...
To Stephen Hay, who was the first person I heard articulate the
...
```
ABOUT THE AUTHOR 191
We’re tasked with making interfaces for more users in more
